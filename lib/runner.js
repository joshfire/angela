...
/**
 * Catch and report global exceptions
 */
process.on('uncaughtException', function (err) {
  logger.error('Uncaught exception detected. If that seems to be a bug ' +
    'in the code itself and not in some test being badly written, ' +
    'please report the issue to https://github.com/joshfire/angela/issues');
  throw err;
});
